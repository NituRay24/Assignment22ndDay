...
public class AdressBook {
    private static ArrayList<AddressBookModel> list = new ArrayList<AddressBookModel>();

    // AddressBook contact =>
    public ArrayList<AddressBookModel> AddContactsDetails() {
        ...
        AddressBookModel details = new AddressBookModel(firstName, lastName, address, city, state, zip,
               , phoneNumber, email);
        list.add(details);
    ...
    private void editExistingContact() {
        ...
        for (AddressBookModel search : list) {
    ...
    private void viewAddressBook_by_City_Sate() {
        Comparator<AddressBookModel> compareByCitySate = Comparator.comparing(AddressBookContactModel::getCity)
                .thenComparing(AddressBookModel::getState);

        List<AddressBookModel> sortedviewAddressBook_by_City_Sate = list.stream().sorted(compareByCitySate)
                .collect(Collectors.toList());
        for (AddressBookModel result : list) {
            System.out.println(" ");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=============================");
        Scanner userInput = new Scanner(System.in);
        HashMap<String, AdressBook> addressBooks = new HashMap<>();
        AdressBook bookOne = new AdressBook();
        AdressBook bookTwo = new AdressBook();
        AdressBook bookThree = new AdressBook();
        ...
        while (chooseAddressBook >= 1) {
            ...
            AdressBook myAddressBookSystem = new AdressBook();
